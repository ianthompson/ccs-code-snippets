 ...
 * Description: Create, edit, and assign PHP, CSS, and HTML snippets. Includes Safe Mode, Import/Export, GitHub Updater, and Shortcodes.
 * Version: 0.0.10
 * Author: Custom AI
...
define( 'CCS_ACCESS_TOKEN', '' ); // Leave empty unless your repo is Private
// -------------------------------------------------------------------------

class CCS_Code_Snippets_010 {
    ...
    /**
     * Shortcode Handler: [ccs_snippet id=123]
     */
    public function render_shortcode( $atts ) {
        ...
        if ( $active === '' ) $active = 1;
        if ( ! $active ) return ''; // Don't output if inactive
    ...
    public function execute_snippets() {
        ...
        foreach ( $snippets as $snippet ) {
            ...
            // If no hook is defined, it might be a shortcode-only snippet. Skip auto-execution.
...
class CCS_GitHub_Updater {
    ...
    public function check_update( $transient ) {
        ...
        if ( $remote && version_compare( get_plugin_data( $this->file )['Version'], $remote->tag_name, '<' ) ) {
